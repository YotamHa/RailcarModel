...
import il.ac.wis.cs.playgo.playtoolkit.container.PlayableFramework.PlayableOriginated;
...
public interface IPlayableContainer
{
	...
	boolean isOriginatedFromGui();

	void setOriginatedFromGui(boolean originatedFromGui);
