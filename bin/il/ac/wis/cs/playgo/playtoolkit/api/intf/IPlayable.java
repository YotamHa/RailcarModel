...
public interface IPlayable{
	...
	/**
	 * dynamic construction and destruction of objects is not supported.	
	 */
	void construct(String className, String objectName);

	/**
	 * dynamic destruction	
	 */
	void destroy(String className, String objectName);
	
	/**
	 * @param playOut - true for playOut, false for playIn
	 */
	void playgoIsUp(boolean playOut);
}
