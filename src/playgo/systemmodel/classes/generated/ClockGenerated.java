    ...
    extends SMBaseClass
{
    ...
    public ClockGenerated(java.lang.String name) {
        super(name);
        il.ac.wis.cs.playgo.playtoolkit.AppObjects.addObject(this);
    ...
    public void tick() {
        ...
        PlaygoCoordinator.getInstance().publishTick();
        PlaygoCoordinator.getInstance().publish(this, getName(), this, getName(), "tick", new java.util.ArrayList<String>(), new java.util.ArrayList<Object>());
        return ;
    }
