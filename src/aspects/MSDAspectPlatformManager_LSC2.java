...
public class MSDAspectPlatformManager_LSC2 extends MSDAspect implements MSDSubscribe
{
 ...
 &&  this.validateBoundedObject(activeMSD,PlatformManager_INST_platformManager,targetObject))
			...
			MSDMethodSet CV,MSDMethodSet HV,ActiveMSDAspect activeMSD)
	{
		...
		MSDMethod MSDm163 = new MSDMethod(User,platformManager,
		...
		MSDMethod MSDm164 = new MSDMethod(platformManager,platformManager,
			MSDMethods.PlatformManager_PlatformManager_setPlatform3busy,args164,"PlatformManager:PlatformManager:setPlatform3busy",niceName,activeMSD.getGlobalId());// setPlatform3busy() Execute
