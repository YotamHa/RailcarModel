...
public class MSDAspectSysManager_InitTerminal4 extends MSDAspect implements MSDSubscribe
{
			...
			MSDMethodSet CV,MSDMethodSet HV,ActiveMSDAspect activeMSD)
	{
		...
		MSDMethod MSDm62 = new MSDMethod(sysManager,sysManager,
		...
		ArrayList<Object>  args63 = getArgsList(VAR_int_exact_int_arg03);
		MSDMethod MSDm63 = new MSDMethod(sysManager,entrance1r,
			MSDMethods.SysManager_Entrance_setTerminalId,args63,"SysManager:Entrance:setTerminalId",niceName,activeMSD.getGlobalId());// setTerminalId() Execute
		ArrayList<Object>  args64 = getArgsList(VAR_int_exact_int_arg05);
		MSDMethod MSDm64 = new MSDMethod(sysManager,entrance1l,
			MSDMethods.SysManager_Entrance_setTerminalId,args64,"SysManager:Entrance:setTerminalId",niceName,activeMSD.getGlobalId());// setTerminalId() Execute
		ArrayList<Object>  args65 = getArgsList(VAR_String_exact_String_arg04);
		MSDMethod MSDm65 = new MSDMethod(sysManager,entrance1r,
			MSDMethods.SysManager_Entrance_setDirection,args65,"SysManager:Entrance:setDirection",niceName,activeMSD.getGlobalId());// setDirection() Execute
		ArrayList<Object>  args66 = getArgsList(VAR_String_exact_String_arg06);
		MSDMethod MSDm66 = new MSDMethod(sysManager,entrance1l,
			MSDMethods.SysManager_Entrance_setDirection,args66,"SysManager:Entrance:setDirection",niceName,activeMSD.getGlobalId());// setDirection() Execute
		ArrayList<Object>  args67 = getArgsList(VAR_int_exact_int_arg00);
		MSDMethod MSDm67 = new MSDMethod(sysManager,terminal1,
			MSDMethods.SysManager_Terminal_setLocation,args67,"SysManager:Terminal:setLocation",niceName,activeMSD.getGlobalId());// setLocation() Execute
		ArrayList<Object>  args68 = getArgsList(VAR_String_exact_String_arg09);
		MSDMethod MSDm68 = new MSDMethod(sysManager,exit1r,
			MSDMethods.SysManager_Exit_setDirection,args68,"SysManager:Exit:setDirection",niceName,activeMSD.getGlobalId());// setDirection() Execute
		ArrayList<Object>  args69 = getArgsList(VAR_String_exact_String_arg011);
		MSDMethod MSDm69 = new MSDMethod(sysManager,exit1l,
			MSDMethods.SysManager_Exit_setDirection,args69,"SysManager:Exit:setDirection",niceName,activeMSD.getGlobalId());// setDirection() Execute
		ArrayList<Object>  args70 = getArgsList(VAR_int_exact_int_arg07);
		MSDMethod MSDm70 = new MSDMethod(sysManager,existsManager1,
			MSDMethods.SysManager_ExitsManager_setID,args70,"SysManager:ExitsManager:setID",niceName,activeMSD.getGlobalId());// setID() Execute
		ArrayList<Object>  args71 = getArgsList(VAR_int_exact_int_arg01);
		MSDMethod MSDm71 = new MSDMethod(sysManager,terminal1,
			MSDMethods.SysManager_Terminal_setID,args71,"SysManager:Terminal:setID",niceName,activeMSD.getGlobalId());// setID() Execute
		ArrayList<Object>  args72 = getArgsList(VAR_int_exact_int_arg02);
		MSDMethod MSDm72 = new MSDMethod(sysManager,platformManager1,
			MSDMethods.SysManager_PlatformManager_setID,args72,"SysManager:PlatformManager:setID",niceName,activeMSD.getGlobalId());// setID() Execute
		ArrayList<Object>  args73 = getArgsList(VAR_int_exact_int_arg08);
		MSDMethod MSDm73 = new MSDMethod(sysManager,exit1r,
			MSDMethods.SysManager_Exit_setID,args73,"SysManager:Exit:setID",niceName,activeMSD.getGlobalId());// setID() Execute
		ArrayList<Object>  args74 = getArgsList(VAR_int_exact_int_arg010);
		MSDMethod MSDm74 = new MSDMethod(sysManager,exit1l,
			MSDMethods.SysManager_Exit_setID,args74,"SysManager:Exit:setID",niceName,activeMSD.getGlobalId());// setID() Execute

		 if(activeMSD.isInCut(0,0,0,0,0,0,0,0))
		{
				ME.add(MSDm62);
				CV.add(MSDm64,MSDm66,MSDm71,MSDm63,MSDm69,MSDm68,MSDm72,MSDm74);
				CV.add(MSDm65,MSDm67,MSDm73,MSDm70);
				return;
		}
		 if(activeMSD.isInCut(1,0,0,0,0,0,0,0))
		{
				...
				HV.add(MSDm64,MSDm66,MSDm71,MSDm63,MSDm69,MSDm68,MSDm72,MSDm74);
				HV.add(MSDm65,MSDm62,MSDm73,MSDm70);
				return;
		}
		 if(activeMSD.isInCut(2,1,0,0,0,0,0,0))
		{
				...
				HV.add(MSDm64,MSDm66,MSDm63,MSDm69,MSDm68,MSDm65,MSDm62,MSDm67);
				return;
		}
		 if(activeMSD.isInCut(3,2,0,0,0,0,0,0))
		{
		 ...
		 if(activeMSD.isInCut(4,2,1,0,0,0,0,0))
		{
				...
				HV.add(MSDm66,MSDm71,MSDm69,MSDm68,MSDm72,MSDm74,MSDm65,MSDm62);
				HV.add(MSDm67,MSDm73,MSDm70);
				return;
		}
		 if(activeMSD.isInCut(5,2,1,1,0,0,0,0))
		{
				...
				HV.add(MSDm64,MSDm71,MSDm63,MSDm72,MSDm74,MSDm62,MSDm67,MSDm73);
				HV.add(MSDm70);
				return;
		}
		 if(activeMSD.isInCut(6,2,1,2,0,0,0,0))
