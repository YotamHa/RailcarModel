//  The file MSDAspectCarHandler_HandleDeparture.aj was automatically generated using S2A 2.0.0.qualifier.
...
public class MSDAspectCarHandler_HandleDeparture extends MSDAspect implements MSDSubscribe
{
	...
	private final String niceName = "CarHandler_HandleDeparture";

	private static MSDAspectCarHandler_HandleDeparture instance = null;

	public static MSDAspectCarHandler_HandleDeparture getInstance(){
		if(instance==null){
			instance = new MSDAspectCarHandler_HandleDeparture();
		}
		return instance;
	}

	private MSDAspectCarHandler_HandleDeparture()
	{
