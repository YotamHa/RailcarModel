...
public class MSDAspectPlatformManager_AllocatePlatform extends MSDAspect implements MSDSubscribe
{
			...
			MSDMethodSet CV,MSDMethodSet HV,ActiveMSDAspect activeMSD)
	{
		...
		ArrayList<Object>  args154 = getArgsList(VAR_boolean_exact_boolean_arg04);
		MSDMethod MSDm154 = new MSDMethod(terminal,platformManager,
			MSDMethods.Terminal_PlatformManager_setPlatform3busy,args154,"Terminal:PlatformManager:setPlatform3busy",niceName,activeMSD.getGlobalId());// setPlatform3busy() Execute
		ArrayList<Object>  args155 = getArgsList(VAR_boolean_exact_boolean_arg02);
		MSDMethod MSDm155 = new MSDMethod(terminal,platformManager,
			MSDMethods.Terminal_PlatformManager_setPlatform2busy,args155,"Terminal:PlatformManager:setPlatform2busy",niceName,activeMSD.getGlobalId());// setPlatform2busy() Execute
		ArrayList<Object>  args156 = getArgsList(VAR_boolean_exact_boolean_arg06);
		MSDMethod MSDm156 = new MSDMethod(terminal,platformManager,
			MSDMethods.Terminal_PlatformManager_setPlatform4busy,args156,"Terminal:PlatformManager:setPlatform4busy",niceName,activeMSD.getGlobalId());// setPlatform4busy() Execute
		ArrayList<Object>  args157 = getArgsList(VAR_boolean_exact_boolean_arg00);
		MSDMethod MSDm157 = new MSDMethod(terminal,platformManager,
			MSDMethods.Terminal_PlatformManager_setPlatform1busy,args157,"Terminal:PlatformManager:setPlatform1busy",niceName,activeMSD.getGlobalId());// setPlatform1busy() Execute
		ArrayList<Object>  args158 = getArgsList(VAR_int_exact_int_number3);
		...
		ArrayList<Object>  args159 = getArgsList(VAR_int_symbolic_var_number);
		...
		ArrayList<Object>  args160 = getArgsList(VAR_int_exact_int_number5);
		...
		ArrayList<Object>  args161 = getArgsList(VAR_int_exact_int_number1);
		...
		MSDMethod MSDm162 = new MSDMethod(terminal,platformManager,
		...
		{
				ME.add(MSDm162);
				CV.add(MSDm158,MSDm159,MSDm160,MSDm161,MSDm156,MSDm155,MSDm157,MSDm154);
				return;
		}
		 if(activeMSD.isInCut(3,3))
		{
				...
				HV.add(MSDm158,MSDm159,MSDm160,MSDm161,MSDm156,MSDm155,MSDm162,MSDm154);
				return;
		}
		 if(activeMSD.isInCut(4,4))
		{
				...
				HV.add(MSDm156,MSDm155,MSDm162,MSDm157,MSDm154);
				return;
		}
		 if(activeMSD.isInCut(6,6))
		{
				...
				HV.add(MSDm158,MSDm159,MSDm160,MSDm161,MSDm156,MSDm162,MSDm157,MSDm154);
				return;
		}
		 if(activeMSD.isInCut(7,7))
		{
		 ...
		 if(activeMSD.isInCut(9,9))
		{
				...
				HV.add(MSDm158,MSDm159,MSDm160,MSDm161,MSDm156,MSDm155,MSDm162,MSDm157);
				return;
		}
		 if(activeMSD.isInCut(10,10))
		{
		 ...
		 if(activeMSD.isInCut(12,12))
		{
				...
				HV.add(MSDm158,MSDm159,MSDm160,MSDm161,MSDm155,MSDm162,MSDm157,MSDm154);
				return;
		}
		 if(activeMSD.isInCut(13,13))
		{
